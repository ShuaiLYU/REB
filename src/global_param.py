...
hyp=ET.Param(pretrained=True)
hyp.img_norm=ET.Param(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
hyp.layer="L23"
hyp.coreset=1
hyp.ldknn_factor=1

hyp.ad_method="NNHead"
hyp.nn_types = [ NN_Type.ldknn]

hyp.ks=[3,5,7,9,11]  # for mvtec
