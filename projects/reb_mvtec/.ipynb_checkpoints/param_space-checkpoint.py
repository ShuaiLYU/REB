...
from src.global_param import Mvtec


base=ET.Param()
base.device="cuda"
base.gpu_id="0"
base.mvt_data=ET.Param(root_dir=Mvtec.data_dir,all_types=Mvtec.all_types,size=256,mode="train")
base.all_types = Mvtec.all_types
base.fewshot=None
